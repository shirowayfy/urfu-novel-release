...
label start:
    ...
    "Сергей с недоверием посмотрел на телефон,протирая глаза. Его в самом деле приняли в FuRA."
    ...
    main_character "Поступил? Ты тоже подавал в FuRA?"
    ...
    main_character "Не думал, что FuRA выглядит так круто. Не зря говорили, что Екб красив. У них даже свой Гарвард есть."
    ...
    friend_character 'Да ладно тебе, я просто забил “FuRA” в навигаторе и мы пришли по адресу, который мне показали "Карты тридевятого царства", тут их “Яндекс карты” называют. Хорошее приложение кстати, правда на болоте бывает сбоит.'
    ...
    main_character "Дубина ты стоеросовая! Мы пришли не туда. Это главное здание  FuRA, а нам в тот, что рядом, в ИРИТ-РТФ!"
